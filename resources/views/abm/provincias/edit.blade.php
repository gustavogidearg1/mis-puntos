...
<div class="card mat-card">
  <div class="mat-header">
    <h3 class="mat-title mb-0"><i class="bi bi-pencil-square"></i> Editar Provincia</h3>
    <div class="ms-auto">
  ...
  <div class="card-body">
    <form method="POST" action="{{ route('abm.provincias.update',$provincia) }}" class="row g-3">
      @csrf @method('PUT')
      ...
      <div class="col-md-6">
        ...
        <select name="pais_id" class="form-select" required>
          ...
          @foreach($paises as $pais)
            <option value="{{ $pais->id }}" @selected(old('pais_id',$provincia->pais_id) == $pais->id)>
              {{ $pais->nombre }}
            </option>
          @endforeach
        </select>
      ...
      <div class="col-md-6">
        ...
        <input name="nombre" class="form-control" value="{{ old('nombre',$provincia->nombre) }}" required>
