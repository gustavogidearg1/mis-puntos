...
{{-- ✅ Tip iPhone (HTML) - DEBE IR ANTES del script --}}
  ...
  <div class="ios-a2hs-card">
    <div class="ios-a2hs-row">
      ...
      <div style="min-width:0;">
        <p class="ios-a2hs-title" id="ios-a2hs-title">Agregar MisPuntos a tu inicio</p>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const KEY = 'mispuntos_ios_a2hs_last_seen_v1';
    const now = Date.now();
    ...
    if (inApp) {
      ...
      text.innerHTML = 'Estás dentro de una app. Para instalar MisPuntos, primero abrí el sitio en <strong>Safari</strong>.';
      pills.classList.add('d-none');
      inapp.classList.remove('d-none');
    } else if (safari) {
      icon.textContent = '⤴︎';
      title.textContent = 'Agregar MisPuntos a tu inicio';
